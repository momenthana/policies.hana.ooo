  ...
  return (
    <div>
      <p className="ls2 lh6 bs5 ts4">
        하나(&#39;hana.ooo&#39;이하 &#39;Hana&#39;)은(는) 「개인정보 보호법」
      ...
      <p className="lh6 bs4">
        <strong>
          ...
          <br />
          <br />
          하나(&#39;hana.ooo&#39;이하 &#39;Hana&#39;)은(는) 다음의 목적을 위하여
      ...
      <ul className="list_indent2 mgt10">
        ...
        <p className="ls2">
          ...
          제공, 본인인증, 연령인증, 요금결제·정산을 목적으로 개인정보를
          처리합니다.
        </p>
        <br />
      ...
      <p className="lh6 bs4">
        ...
        <br />
        <br />① 하나은(는) 법령에 따른 개인정보 보유·이용기간 또는
      ...
      <ul className="list_indent2 mgt10">
        ...
        <li className="tt">
          ...
          동의일로부터 지체없이 파기까지 위 이용목적을 위하여 보유.이용됩니다.
        </li>
        <li>보유근거 : 홈페이지 회원가입 및 관리</li>
      </ul>
      <ul className="list_indent2 mgt10">
        <li className="tt">2. 민원사무 처리</li>
        <li className="tt">
      ...
      <ul className="list_indent2 mgt10">
        <li className="tt">4. 마케팅 및 광고에의 활용</li>
        <li className="tt">
          마케팅 및 광고에의 활용과 관련한 개인정보는 수집.이용에 관한
          동의일로부터 6개월까지 위 이용목적을 위하여 보유.이용됩니다.
        </li>
        <li>보유근거 : 마케팅 및 광고에의 활용</li>
      ...
      <p className="lh6 bs4">
        ...
        <br />① 하나은(는) 다음의 개인정보 항목을 처리하고 있습니다.
      </p>
      <ul className="list_indent2 mgt10">
        <li className="tt">1. 홈페이지 회원가입 및 관리</li>
        <li>
          필수항목 : 이메일, 휴대전화번호, 비밀번호, 로그인ID, 성별, 생년월일,
          이름, 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보
        </li>
        <li>선택항목 : 로그인ID, 성별</li>
      </ul>
      <ul className="list_indent2 mgt10">
      ...
      <ul className="list_indent2 mgt10">
        <li className="tt">4. 마케팅 및 광고에의 활용</li>
        <li>
          필수항목 : 이메일, 로그인ID, 서비스 이용 기록, 접속 로그, 쿠키, 접속
          IP 정보
        </li>
        <li>선택항목 : 성별</li>
      </ul>
      ...
      <p className="lh6 bs4">
        ...
        <br />
        <br />① 하나은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한
        범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등
        「개인정보 보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를
        제3자에게 제공합니다.
      </p>
      <p className="sub_p mgt10">
        ② <span className="colorLightBlue">하나</span>은(는) 다음과 같이
        개인정보를 제3자에게 제공하고 있습니다.
      </p>
      <ul className="list_indent2 mgt10">
        <li className="tt">1. Google</li>
        <li>개인정보를 제공받는 자 : Google</li>
        <li>
          제공받는 자의 개인정보 이용목적 : 로그인ID, 성별, 서비스 이용 기록,
      ...
      <p className="ls2">
        <br />① 하나은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가
        ...
        1. 파기절차
        <br />
        하나은(는) 파기 사유가 발생한 개인정보를 선정하고, 하나의 개인정보
      ...
      <br />
      <p className="lh6 bs4">
        <strong>제6조(미이용자의 개인정보 파기 등에 관한 조치)</strong>
      </p>
      <p className="ls2">
        <br />
        <br />① 하나은(는) 1년간 서비스를 이용하지 않은 이용자는 휴면계정으로
        전환하고, 개인정보를 별도로 분리하여 보관합니다. 분리 보관된 개인정보는
        1년간 보관 후 지체없이 파기합니다.
        <br />② 하나은(는) 휴먼전환 30일 전까지 휴면예정 회원에게 별도 분리
        보관되는 사실 및 휴면 예정일, 별도 분리 보관하는 개인정보 항목을 이메일,
      ...
      <p className="ls2">
        <br />
        <br />① 정보주체는 하나에 대해 언제든지 개인정보 열람·정정·삭제·처리정지
        요구 등의 권리를 행사할 수 있습니다.
      </p>
      <p className="sub_p">
        ② 제1항에 따른 권리 행사는하나에 대해 「개인정보 보호법」 시행령
        제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
        있으며 하나은(는) 이에 대해 지체 없이 조치하겠습니다.
      </p>
      <p className="sub_p">
      ...
      <p className="sub_p">
        ⑥ 하나은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
      ...
      <p className="lh6 bs4">
        <strong>
          ...
          <br />
          <br />
          하나은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고
          있습니다.
        </strong>
      </p>
      <p className="sub_p mgt10">
        ...
        4. 해킹 등에 대비한 기술적 대책
        <br />
        하나(&#39;Hana&#39;)은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출
        및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며
      ...
      <p className="ls2">
        <br />
        <br />① 하나은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해
      ...
      <p className="ls2">
        <br />
        <br />① 하나은(는) 서비스 이용과정에서 정보주체에게 최적화된 맞춤형
        서비스 및 혜택, 온라인 맞춤형 광고 등을 제공하기 위하여 행태정보를
        수집·이용하고 있습니다.
      </p>
      <p className="sub_p">② 하나은(는) 다음과 같이 행태정보를 수집합니다.</p>
      <table className="tb_board td_border_all tb_board_view tb_row mgt10">
        <caption>
          10. 행태정보의 수집·이용·제공 및 거부 등에 관한 사항 제공을 위해
          수집하는 행태정보의 항목, 행태정보 수집 방법, 행태정보 수집 목적,
          보유·이용기간 및 이후 정보처리 방법을 입력하기 위한 표입니다.
        </caption>
        <colgroup>
          <col width="auto" />
          <col width="auto" />
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="txtc">
              이용자의 웹 사이트 및 앱방문/실행시 자동 수집
            </td>
            <td className="txtc">
              이용자의 관심, 성향에 기반한 개인 맞춤형
              상품추천서비스(광고포함)를 제공
            </td>
            <td className="txtc">수집일로부터 6개월 후 파기</td>
          </tr>
        </tbody>
      </table>
      <p className="sub_p"></p>
      <div className="panel_box panel_white">
        ...
        <p className="sub_p">
          ③ 하나은(는) 다음과 같이 온라인 맞춤형 광고 사업자가 행태정보를
          수집·처리하도록 허용하고 있습니다.
        </p>
        <p className="sub_p">
        ...
        <p className="sub_p">
          - 행태정보 수집 방법 : 이용자가 당사 웹사이트를 방문하거나 앱을 실행할
          때 자동 수집 및 전송
        </p>
        <p className="sub_p">
        ...
        <p className="sub_p">- 보유·이용기간 : 준영구</p>
      </div>
      <p className="sub_p">
        ④ 하나은(는) 온라인 맞춤형 광고 등에 필요한 최소한의 행태정보만을
        수집하며, 사상, 신념, 가족 및 친인척관계, 학력·병력, 기타 사회활동 경력
        등 개인의 권리·이익이나 사생활을 뚜렷하게 침해할 우려가 있는 민감한
        행태정보를 수집하지 않습니다.
      </p>
      <p className="sub_p">
        ⑤ 하나은(는) 만 14세 미만임을 알고 있는 아동이나 만14세 미만의 아동을 주
        이용자로 하는 온라인 서비스로부터 맞춤형 광고 목적의 행태정보를 수집하지
        않고, 만 14세 미만임을 알고 있는 아동에게는 맞춤형 광고를 제공하지
        않습니다.
      </p>
      <p className="sub_p">
        ⑥ 하나은(는) 모바일 앱에서 온라인 맞춤형 광고를 위하여 광고식별자를
      ...
      <p className="sub_p">
        (2) (아이폰) ① 설정 → ② 개인정보보호 → ③ 추적 → ④ 앱이 추적을 요청하도록
        허용 끔
      </p>
      <p className="sub_p">
      ...
      <p className="sub_p">부서명 : 개인정보 보호 담당부서</p>
      <p className="sub_p">담당자 : 하나</p>
      <p className="sub_p">연락처 : privacy@hana.ooo</p>
      <br />
      <br />
      <p className="lh6 bs4">
        ...
        <br />
        <br />
        하나은(는) ｢개인정보 보호법｣ 제15조제3항 및 제17조제4항에 따라 ｢개인정보
        보호법 시행령｣ 제14조의2에 따른 사항을 고려하여 정보주체의 동의 없이
        개인정보를 추가적으로 이용·제공할 수 있습니다.
        <br />
        이에 따라 하나 가(이) 정보주체의 동의 없이 추가적인 이용·제공을 하기
        위해서 다음과 같은 사항을 고려하였습니다.
        <br />▶ 개인정보를 추가적으로 이용·제공하려는 목적이 당초 수집 목적과
        관련성이 있는지 여부
      </p>
      <p className="sub_p"></p>
      <p className="sub_p"></p>
      ...
      <p className="lh6 bs4">
        ...
        <br />
        <br />
        하나은(는) 다음과 같은 목적으로 가명정보를 처리하고 있습니다.
      </p>
      <p className="sub_p"></p>
      <p className="sub_p">▶ 가명정보의 처리 목적</p>
      <p className="sub_p">- 1. 홈페이지 회원가입 및 관리</p>
      <p className="sub_p"></p>
      <p className="sub_p">- 2. 민원사무 처리</p>
      <p className="sub_p"></p>
      <p className="sub_p">- 3. 재화 또는 서비스 제공</p>
      <p className="sub_p"></p>
      <p className="sub_p">- 4. 마케팅 및 광고에의 활용</p>
      <p className="sub_p"></p>
      <p className="sub_p">▶ 가명정보의 처리 및 보유기간</p>
      <p className="sub_p">- 준영구</p>
      <p className="sub_p"></p>
      <p className="sub_p">▶ 가명처리하는 개인정보의 항목</p>
      <p className="sub_p">
        - 이메일, 휴대전화번호, 비밀번호, 로그인ID, 성별, 생년월일, 이름, 서비스
      ...
      <p className="sub_p">
        ...
        별도로 분리하여 보관·관리하는 등 해당 정보가 분실·도난·유출·위조·변조
        또는 훼손되지 않도록 안전성 확보에 필요한 기술적·관리적 및 물리적 조치를
        합니다.
      </p>
      <br />
      <br />
      ...
      <p className="sub_p mgt10">
        ① 하나은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
      ...
      <ul className="list_indent2 mgt10">
        ...
        <li>담당자 : 하나</li>
        <li>연락처 : privacy@hana.ooo</li>
      </ul>
      <p className="sub_p">
        ② 정보주체께서는 하나의 서비스(또는 사업)을 이용하시면서 발생한 모든
        개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보
        보호책임자 및 담당부서로 문의하실 수 있습니다. 하나은(는) 정보주체의
      ...
      <p className="sub_p mgt30">
        <strong>
          ...
          아래의 부서에 할 수 있습니다.
          <br />
          하나은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록
          노력하겠습니다.
        </strong>
      </p>
      <ul className="list_indent2 mgt10">
        <li className="tt">▶ 개인정보 열람청구 접수·처리 부서</li>
        <li>부서명 : 개인정보 열람청구 접수·처리 부서</li>
        <li>담당자 : 하나</li>
        <li>연락처 : privacy@hana.ooo</li>
      </ul>
      <br />
      ...
      <p className="sub_p"></p>
      <p className="sub_p"></p>
      {/* <p className="sub_p">- 20XX. X. X ~ 20XX. X. X 적용 (클릭)</p> */}
    </div>
  );
};
